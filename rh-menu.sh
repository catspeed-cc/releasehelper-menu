...
while true; do
    ...
    case "${choice,,}" in
        ...
        "1")
            ...
            echo "------------------------------------"
            script_name="${GIT_ROOT}/release-build-docker.sh"
            ...
            if [[ -x "$script_name" ]]; then
                ...
                echo "💡 Make sure it exists and has execute permissions: chmod +x $script_name"
            fi
        ...
        "2")
            ...
            echo "------------------------"
            script_name="${GIT_ROOT}/release-gen-sauces.sh"
        ...
        "3")
            ...
            echo "----------------------------------------"
            script_name="${GIT_ROOT}/release-gh-push.sh"
